(() => {
  ...
  chrome.storage.sync.get(["highlightEnabled", "borderColor", "borderOpacity", "blacklistDomains", "extensionEnabled"], (result) => {
    ...
    isEnabled = extensionEnabled && !checkBlacklist(blacklistDomains);
    updateStyles();
  });
